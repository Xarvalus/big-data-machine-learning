package xarvalus.reactive.stock.api
...
object ReactivestockService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The reactive-stock service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ReactivestockService.
  */
trait ReactivestockService extends Service {
  ...
  override final def descriptor: Descriptor = {
    import Service._
    // @formatter:off
    named("reactive-stock")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(ReactivestockService.TOPIC_NAME, greetingsTopic _)
